...
type Document struct {
	Fields *map[string]Value `json:"fields,omitempty" xml:"fields"`
}

// Value defines model for Value.
type Value struct {
	ArrayValue  *ArrayValue `json:"arrayValue,omitempty" xml:"arrayValue"`
	StringValue *string     `json:"stringValue,omitempty" xml:"stringValue"`
}
