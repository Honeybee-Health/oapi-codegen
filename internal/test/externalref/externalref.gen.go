...
type Container struct {
	...
	ObjectB *externalRef1.ObjectB   `json:"object_b,omitempty" xml:"object_b"`
	ObjectC *map[string]interface{} `json:"object_c,omitempty" xml:"object_c"`
	Pet     *externalRef2.Pet       `json:"pet,omitempty" xml:"pet"`
}
